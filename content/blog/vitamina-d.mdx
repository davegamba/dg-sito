...
A questo si aggiungono altri fattori che aumentano il rischio: l'uso costante di creme solari ad alta protezione — anche se su questo punto va fatta una precisazione: il consenso internazionale disponibile indica che l'uso quotidiano e ricreativo **non compromette** la sintesi di vitamina D, e il quadro completo l'ho ricostruito in [crema solare fa male?](/blog/crema-solare-fa-male) — la pelle più scura (che richiede tempi di esposizione più lunghi), l'età superiore ai 50 anni (la pelle sintetizza meno vitamina D con l'avanzare dell'età), e i mesi invernali, quando l'angolazione del sole in Italia è insufficiente per la sintesi cutanea indipendentemente da quanto tempo si passa all'aperto.
