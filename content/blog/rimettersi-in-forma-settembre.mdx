...
image: /images/blog/rientro-settembre-C-davegamba.jpeg
published: true
---
...
- I 21 giorni **non bastano a creare un'abitudine**: il tempo reale è di 66 giorni, e per l'attività fisica sale a 91. Chi ti vende i 21 giorni come "il tempo per cambiare" ti sta preparando a mollare al giorno 22.
...
> Dopo un lungo stop il muscolo torna quasi alle dimensioni di partenza, ma la forza resta in gran parte. In uno studio su 20 settimane di stop completo lo spessore del muscolo era tornato al punto di partenza, mentre la forza restava elevata di circa il 60% rispetto a quanto guadagnato: il corpo si ricorda il gesto anche a distanza di mesi. Il rientro non è ricostruire da zero, è riaccendere. I progressi delle prime settimane arrivano dal sistema nervoso, non da muscolo nuovo. Un piano di rientro che funziona parte da 2-3 sedute di forza a settimana con poco volume, aumenta un solo parametro alla volta, e mette per iscritto in anticipo cosa fare nei giorni in cui salteresti.
...
Uno studio su donne over 50 che avevano fatto 12 settimane di allenamento con i pesi ha misurato cosa succede in **sole 4 settimane** di stop. Sono calati il carico massimo ai curl, la massa magra — il peso del corpo senza contare il grasso — e la mobilità del tronco. Nello stesso tempo sono saliti la percentuale di grasso e le pliche misurate col plicometro, lo strumento che misura il grasso sottopelle ([Delshad et al., Int J Prev Med, 2013](https://pubmed.ncbi.nlm.nih.gov/24498494/)). Quattro settimane. Non sei mesi.

Ma ecco il dato che cambia la prospettiva. In uno studio su giovani adulti sani, dopo 8 settimane di allenamento e poi 2 e 4 settimane di stop, il muscolo della coscia si era **sì ridotto rispetto a fine allenamento, ma restava comunque più spesso di quando avevano iniziato** ([McMahon et al., Front Physiol, 2019](https://doi.org/10.3389/fphys.2019.00527)).

Tradotto: il muscolo si sgonfia, non scompare.

| Cosa | Dopo 4 settimane di stop | Dopo mesi di stop |
|---|---|---|
| Volume muscolare | Ridotto, ma sopra il punto di partenza | Tende a tornare al punto di partenza |
| Forza massima | Calo misurabile | Resta largamente sopra il punto di partenza |
...
Uno studio ha fatto una cosa che quasi nessuno fa: ha seguito 19 persone attraverso **10 settimane di allenamento, 20 settimane di stop completo e 5 settimane di ripresa**, prelevando ogni volta un campione di muscolo per misurarlo davvero. Durante l'allenamento iniziale la sezione delle fibre è cresciuta del 17%, lo spessore del muscolo del 10%, la forza del 20%.

Poi sono arrivate le 20 settimane di niente.

Spessore del muscolo e sezione delle fibre **sono tornati ai valori di partenza**. La forza, invece, **è rimasta elevata di circa il 60%** rispetto a quanto guadagnato ([Psilander et al., J Appl Physiol, 2019](https://doi.org/10.1152/japplphysiol.00917.2018)). Secondo gli autori il motivo è che il corpo impara il gesto e non lo dimentica per molto tempo.

**Il muscolo se n'è andato. La capacità di usarlo è rimasta lì.**

Ha senso se pensi a cosa la forza è davvero. Non è solo quanta carne hai. È quante fibre riesci ad attivare insieme, quanto spesso riesci a farle contrarre, quanto riesci a spegnere i muscoli che frenano il movimento. Tutta roba di sistema nervoso. E il sistema nervoso non dimentica un gesto motorio in due mesi al mare, allo stesso modo in cui non dimentichi come si va in bicicletta.
...
Nelle prime settimane di allenamento la forza sale. Ma non perché il muscolo sia cresciuto — quello richiede più tempo. Sale perché il sistema nervoso impara a usare meglio quello che hai già.

Succedono quattro cose, tutte nel cervello e nei nervi, non nei muscoli: impari ad attivare più fibre insieme, quelle fibre si contraggono più spesso al secondo, i muscoli che frenerebbero il movimento si attivano di meno, e il segnale che parte dal cervello verso il muscolo diventa più forte ([Griffin & Cafarelli, Can J Appl Physiol, 2005](https://doi.org/10.1139/h05-125)).
...
Il dato reale arriva da uno studio su 96 volontari seguiti per 84 giorni. Ognuno doveva ripetere ogni giorno la stessa azione — mangiare, bere o muoversi — sempre nella stessa situazione. Perché diventasse automatica ci sono voluti **66 giorni**: metà delle persone ci ha messo meno, metà di più. E la differenza tra una persona e l'altra era enorme: **da 18 a 254 giorni** ([Lally et al., Eur J Soc Psychol, 2010](https://doi.org/10.1002/ejsp.674)).

E per l'attività fisica in particolare si saliva a **91 giorni** — più di quanto lo studio stesso sia durato, quindi è una stima calcolata, non un dato osservato fino in fondo.

Ci sono altri due dettagli onesti che vale la pena dire, perché quasi nessuno li riporta: più della metà dei partecipanti non è mai arrivata all'automatismo, e 14 hanno abbandonato lo studio. Anche in condizioni controllate, con gente che si era offerta volontaria, l'abitudine non è scattata per tutti.
...
Tre settimane, tre sedute a settimana, nove allenamenti totali. Full body ogni volta, perché con tre sedute a settimana ogni gruppo muscolare viene stimolato tre volte invece di una. Sul perché tre sia il numero giusto — e su quanti minuti servano davvero in una settimana — ho scritto a parte in [quante volte allenarsi a settimana](/blog/quante-volte-allenarsi-a-settimana).
...
Chi studia come le persone cambiano abitudini distingue due tipi di pianificazione:
...
Un lavoro che ha messo insieme 49 studi e 19.883 persone ha verificato quale dei due colma davvero la distanza tra "voglio allenarmi" e "mi alleno". Risultato: il **coping planning funziona davvero**, l'**action planning no** ([Wang et al., Psychol Sport Exerc, 2025](https://doi.org/10.1016/j.psychsport.2025.102822)).
...
Attenzione: pianificare in generale funziona, e su questo la letteratura è solida — una revisione che ha messo insieme 41 studi su 5.439 persone ha trovato un effetto positivo costante di questi piani sull'attività fisica ([Peng et al., Int J Environ Res Public Health, 2022](https://doi.org/10.3390/ijerph19127337)). Il punto non è che pianificare sia inutile. È che stai pianificando la metà sbagliata.
...
**Usare la bilancia come unico strumento.** Nelle prime tre settimane il peso può salire — più glicogeno (gli zuccheri di scorta del muscolo), più acqua trattenuta, più infiammazione normale da riadattamento. È fisiologico e temporaneo, e se non lo sai è il motivo per cui molli al giorno 12. È lo stesso equivoco che sta dietro al [perché non dimagrisco](/blog/perche-non-dimagrisco) nonostante tutto sembri fatto bene.
...
I dati sono corretti. Il piano funziona. I tre "se... allora" li scrivi in cinque minuti.
...
Quello dei due che ti fa presentare tre volte a settimana. Nelle prime tre settimane l'attrezzatura conta pochissimo, perché i carichi sono volutamente bassi e i progressi arrivano dal sistema nervoso, non da muscolo nuovo. Conta molto di più azzerare le frizioni: tempi di spostamento, orari, code agli attrezzi.
