...
image: /images/blog/cortisolo-alto-davegamba.jpeg
---
...
Nell'uomo over 40 questo effetto si somma al calo fisiologico del testosterone, ed è il motivo per cui la pancia resiste anche quando braccia e gambe restano magre: il meccanismo completo è in [perché non dimagrisci più dopo i 40 anni](/blog/dimagrire-dopo-i-40-uomo). Se il tuo problema specifico è proprio il girovita, ho messo insieme i tre meccanismi e il protocollo in [grasso addominale uomo: perché la pancia non va via](/blog/grasso-addominale-uomo).
...
Il dosaggio esatto per restare dentro la soglia di recupero — frequenza, durata, scarichi — è in [testosterone e allenamento: cosa funziona davvero](/blog/testosterone-allenamento-forza).
...
Per la respirazione come strumento anti-cortisolo: [Respirazione e cervello →](/blog/esercizi-respirazione)
