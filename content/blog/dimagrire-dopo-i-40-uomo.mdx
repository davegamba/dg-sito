...
Non significa che allenarsi serva meno. Significa l'opposto: serve di più, perché parti da una base ormonale più bassa. Ho scritto una guida dedicata su [come alzare il testosterone naturalmente dopo i 40](/blog/come-aumentare-testosterone), con la gerarchia esatta degli interventi che funzionano — e una sul solo allenamento, con il dosaggio preciso, in [testosterone e allenamento: cosa funziona davvero](/blog/testosterone-allenamento-forza).
...
Non è un problema estetico marginale: il grasso viscerale è quello metabolicamente più attivo e più correlato al rischio cardiometabolico. Ho dedicato un articolo intero al meccanismo esatto in [cortisolo alto e grasso addominale](/blog/cortisolo-alto), e uno al girovita in particolare — con la differenza tra grasso viscerale e sottocutaneo — in [grasso addominale uomo](/blog/grasso-addominale-uomo).
...
La domanda che mi fanno tutti. Ecco i riferimenti realistici per un uomo over 40 che applica il protocollo con costanza. Se stai ripartendo dopo un lungo stop, però, le prime tre settimane hanno regole loro — le trovi nel [piano di rientro](/blog/rimettersi-in-forma-settembre), dieta inclusa.
...
Ogni numero che hai letto qui dentro è la media di migliaia di persone.

Tu non sei migliaia di persone.

Sei uno, con una storia precisa alle spalle — ed è quella a decidere dove cadi dentro la media.
