...
image: /images/blog/esercizi-dorsali-davegamba.jpeg
---
...
**Erettori spinali** — la colonna portante della schiena. Lavorano senza muoversi durante quasi ogni esercizio, tenendo la colonna ferma e stabile. Trascurarli porta a dolori lombari che si manifestano non durante l'allenamento ma nella vita quotidiana.
...
La ricerca sul carico durante l'allungamento dimostra che questa fase è responsabile di una quota significativa della crescita del muscolo — fino al 40% in più rispetto alla sola fase di spinta. [Fonte: PMID 31230236](https://pubmed.ncbi.nlm.nih.gov/31230236/)
...
Allenare i dorsali tre volte a settimana sempre con gli stessi esercizi produce adattamento rapido e stagnazione. Due sessioni settimanali che alternano il tipo di movimento — una verticale e una orizzontale — produce risultati superiori con meno volume totale.
...
**Errore comune:** Portare la barra dietro la nuca. Aumenta il rischio che i tendini del collo vengano schiacciati, senza nessun vantaggio in più per il muscolo. La barra va sempre davanti, verso il petto.
...
Una schiena forte protegge anche le spalle nelle spinte sopra la testa — trovi la scheda dedicata in [esercizi spalle](/blog/esercizi-spalle).
...
I dorsali non crescono con una sola sessione settimanale da 10 esercizi. Crescono con due sessioni da 3 esercizi ciascuna, organizzate per un tipo di movimento diverso.
...
Le trazioni producono una maggiore attivazione del gran dorsale e coinvolgono più muscoli stabilizzatori. La lat machine permette di regolare il carico con precisione — fondamentale nella fase iniziale. La risposta corretta: lat machine per imparare il movimento, trazioni come obiettivo finale e come esercizio principale una volta raggiunte.

### I dorsali si allenano bene a casa?

Sì, con la sbarra per trazioni da porta e un paio di manubri. Australian pull-up e rematore con manubrio coprono entrambi i tipi di movimento — verticale e orizzontale. La progressione alle trazioni complete è accessibile a chiunque con una sbarra e il protocollo dei quattro step.

### Perché ho mal di schiena anche se mi alleno?

Spesso il mal di schiena in chi si allena dipende da uno squilibrio: gli erettori spinali si tendono per compensare dorsali e glutei deboli. In questo caso allenare i dorsali correttamente — e aggiungere lavoro per i glutei — risolve il problema più della fisioterapia isolata. Se il dolore è acuto o irradiato, consulta uno specialista prima di procedere. [Fonte: PMID 20436237](https://pubmed.ncbi.nlm.nih.gov/20436237/)
